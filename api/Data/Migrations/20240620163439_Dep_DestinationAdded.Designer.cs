...
namespace api.Data.Migrations
{
    ...
    [Migration("20240620163439_Dep_DestinationAdded")]
    partial class Dep_DestinationAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Entities.Admin.CandidateFlightDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("CandidateFlightId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CandidateFlightId")
                        .IsUnique();

                    b.ToTable("CandidateFlightDetails");
                });
            ...
            modelBuilder.Entity("api.Entities.Admin.FlightDetail", b =>
                {
                    ...
                    b.Property<TimeOnly>("ETA_Destination")
                        .HasColumnType("TEXT");

                    b.Property<TimeOnly?>("ETA_Via")
                        .HasColumnType("TEXT");

                    b.Property<TimeOnly>("ETD_Boarding")
                        .HasColumnType("TEXT");

                    b.Property<TimeOnly?>("ETD_Via")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("api.Entities.Admin.CandidateFlightDetail", b =>
                {
                    b.HasOne("api.Entities.Admin.CandidateFlight", null)
                        .WithOne("CandidateFlightDetail")
                        .HasForeignKey("api.Entities.Admin.CandidateFlightDetail", "CandidateFlightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("api.Entities.Deployments.DepItem", b =>
                {
                    b.HasOne("api.Entities.Admin.CandidateFlight", null)
                        .WithMany("depItems")
                        .HasForeignKey("CandidateFlightId");

                    b.HasOne("api.Entities.Deployments.Dep", "Dep")
                        .WithMany("DepItems")
                        .HasForeignKey("DepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("api.Entities.Admin.CandidateFlight", b =>
                {
                    b.Navigation("CandidateFlightDetail");
