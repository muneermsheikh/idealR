...
export class MessageComponent implements OnInit {
  ...
  loadMessages(useCache: boolean=false) {
    ...
    console.log('currentpage:', this.currentPage, 'params page', this.msgParams.pageNumber);

   if(this.container === this.lastContainer 
      && (this.msgParams.messageType === this.lastMessageType || this.lastMessageType==='')
      && (this.msgParams.pageNumber === this.currentPage)) return;
    ...
    this.service.getMessages(useCache).subscribe({
      next: response => {
        ...
        this.loading = false;
        this.currentPage = this.msgParams.pageNumber;
      }
    })
